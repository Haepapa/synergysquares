  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto flex items-center justify-between p-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              ...
              onClick={() =>
                user ? setShowAccountMenu(true) : handleAuthClick("login")
              }
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-b from-background to-accent/5">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Make Meetings Fun with{" "}
              <span className="text-accent">Synergy Squares</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-muted-foreground">
              Create custom bingo games for meetings, team building, events, and
              more. Play online with colleagues and friends in real-time.
            </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-accent/20">
                ...
                <CardContent>
                  <p>
                    Create your own bingo boards with custom content, colors,
                    and sizes. Choose from our presets or make your own.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-accent/20">
                ...
                <CardContent>
                  <p>
                    Play together with your team in real-time. Share your game
                    with a simple token and track everyone's progress.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-accent/20">
                ...
                <CardContent>
                  <p>
                    Works in your browser on any device. No downloads or
                    installations required - just create and play!
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-16 bg-accent/5 text-foreground">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">
              How It Works
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p>
                  Choose a template or create your own custom bingo board with
                  your content.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p>
                  Generate a game token and share it with friends or colleagues
                  to join your game.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p>
                  Mark squares as they happen and be the first to get a winning
                  pattern!
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-accent/10">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join thousands of teams who use Synergy Squares to make their
              meetings more fun and interactive.
            </p>
            <Button
              size="lg"
              className="bg-accent hover:bg-accent/90 text-lg"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Synergy Squares. All rights
              reserved.
            </div>
          </div>
        </div>
